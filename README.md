...
When invoked, a highlander launcher looks for existing instances of the selected program, and brings them into focus using wmctrl. Highlander will only a launch new program after failing to locate any existing instances. 
